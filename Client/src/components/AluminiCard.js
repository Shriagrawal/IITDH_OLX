    ...
    >
      {hovered && (
        ...
        >
         ...
         {data.linkedin_url&&<div style={{ marginLeft: "5px" }}>
      ...
      <Card.Body>
        ...
        <Card.Text>Contact no: {data?.phoneNo}
        </Card.Text>
      </Card.Body>
    </Card>
  );
