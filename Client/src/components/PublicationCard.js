  ...
  return (
    ...
    >
      ...
      <Card.Body>
        ...
        <Card.Text>Contact no: {data.contact_no}
        </Card.Text>
        <Button><a href={data.payment_link} style={{textDecoration:'none',color:'white'}} >Pay </a></Button>
      </Card.Body>
    </Card>
  );
}
